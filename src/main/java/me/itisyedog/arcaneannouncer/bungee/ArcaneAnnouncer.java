...
public class ArcaneAnnouncer extends Plugin {
    ...
    private void loadConfig() {
        try {
            ...
            getLogger().log(Level.WARNING,
                    "There was an error. Please message ItIsYeDog#0001 on discord.");
        }
    }

    private void registerCommand() {
        getProxy().getPluginManager().registerCommand(this, new Command("arcaneannouncer", "arcaneannouncer.help", "am") {
            @Override
            public void execute(CommandSender s, String[] args) {
                ...
                if (args[0].equalsIgnoreCase("reload") || args[0].equalsIgnoreCase("rl")) {
                    if (s instanceof ProxiedPlayer && !s.hasPermission("arcaneannouncer.reload")) {
                        sendMessage(s, config.getString("messages.no-permission"));
                        return;
                    }
                    ...
                    if (announce != null) {
                        ...
                        announce = new Announce((ArcaneAnnouncer) getProxy().getPluginManager().getPlugin("ArcaneAnnouncer"));
                    }
                    ...
                    if (s instanceof ProxiedPlayer && !s.hasPermission("arcaneannouncer.toggle")) {
                        sendMessage(s, config.getString("messages.no-permission"));
                        return;
                    }
                    ...
                    if (s instanceof ProxiedPlayer && !s.hasPermission("arcaneannouncer.list")) {
                        sendMessage(s, config.getString("messages.no-permission"));
                        return;
                    }
                    ...
                    if (s instanceof ProxiedPlayer && !s.hasPermission("arcaneannouncer.add")) {
                        sendMessage(s, config.getString("messages.no-permission"));
                        return;
                    }
                    ...
                    if (s instanceof ProxiedPlayer && !s.hasPermission("arcaneannouncer.remove")) {
                        sendMessage(s, config.getString("messages.no-permission"));
                        return;
                    }
